...
export interface IRegionMySuffixUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const RegionMySuffixUpdate = (props: IRegionMySuffixUpdateProps) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterCrudWithFilterApp.region.home.createOrEditLabel">Create or edit a Region</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : regionEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="region-my-suffix-id">ID</Label>
                  <AvInput id="region-my-suffix-id" type="text" className="form-control" name="id" required readOnly />
                </AvGroup>
              ) : null}
              <AvGroup>
                <Label id="regionNameLabel" for="region-my-suffix-regionName">
                  Region Name
                </Label>
                <AvField id="region-my-suffix-regionName" type="text" name="regionName" />
              </AvGroup>
              <Button tag={Link} id="cancel-save" to="/region-my-suffix" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(RegionMySuffixUpdate);
